  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0">
        <img
          src="/image1.jpg"
          alt="VESE Foundation Community Work"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-charcoal/80 via-charcoal/60 to-charcoal/40"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight font-playfair drop-shadow-lg">
              Transforming Lives with
              <span className="block text-sage">Compassion & Generosity</span>
            </h1>
            
            <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-lato drop-shadow">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button className="group bg-sage hover:bg-sage/90 text-white px-8 py-4 rounded-full font-lato font-semibold transition-all duration-300 flex items-center justify-center space-x-2 transform hover:scale-105 shadow-lg">
                <span>Join Our Mission</span>
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
              </button>
              
              <button className="bg-white/90 backdrop-blur-sm hover:bg-white text-charcoal px-8 py-4 rounded-full font-lato font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">
                Learn More
              </button>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <div className="bg-white/95 backdrop-blur-sm p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="bg-sage text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300 transform translate-y-4">
              ...
              <div className="space-y-6 pt-8">
                <div className="bg-cream/95 backdrop-blur-sm p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
